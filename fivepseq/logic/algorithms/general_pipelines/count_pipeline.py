...
class CountPipeline:
    ...
    def run(self):
        ...
        if count_stats.data_summary_series[count_stats.TOTAL_NUM_READS] == 0:
            logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).warning("No reads found in coding regions. Fivepseq will skip the rest of calculations.")

        else:
            #   terminal counts
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                    os.path.exists(self.fivepseq_out.get_file_path(self.fivepseq_out.COUNT_TERM_FILE))):
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.COUNT_TERM_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                ...
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.COUNT_START_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                ...
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.META_COUNT_TERM_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                ...
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.META_COUNT_START_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                ...
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.FRAME_COUNTS_START_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                ...
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.FRAME_COUNTS_TERM_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                ...
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.START_CODON_DICT_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                ...
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.TERM_CODON_DICT_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                ...
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.CANONICAL_TRANSCRIPT_INDEX_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                    os.path.exists(self.fivepseq_out.get_file_path(self.fivepseq_out.TRANSCRIPT_DESCRIPTORS_FILE))):
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.TRANSCRIPT_DESCRIPTORS_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                ...
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.AMINO_ACID_PAUSES_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                ...
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.TRANSCRIPT_ASSEMBLY_FILE)
            else:
            ...
            if (self.fivepseq_out.conflict_mode == config.ADD_FILES) & (
                ...
                logging.getLogger(config.FIVEPSEQ_COUNT_LOGGER).info("Skipping existing file %s" % self.fivepseq_out.LOCI_PAUSES_FILE)
            else:
