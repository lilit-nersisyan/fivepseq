"""
This file references file directories to be used in testing.
"""

# FIXME Currently, local files are used - should be replaced with small integrated files for poratiblity.
# PORT Currently not portable as the files used impose directory dependency
